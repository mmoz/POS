...
$strSQL = "SELECT * FROM product WHERE productcategory LIKE 'อาหาร%' LIMIT {$start} , {$perpage}";
...
<ul class="pagination justify-content-center">
 <li>
 <a href="productcate1.php?page=1" class = "btn btn-outline-success"aria-label="Previous">
 <span aria-hidden="true">&laquo;</span>
 </a>
 </li>
 <?php for($i=1;$i<=$total_page;$i++){ ?>
 <li><a href="productcate1.php?page=<?php echo $i; ?>" class = "btn btn-outline-success"><?php echo $i; ?></a></li>
 <?php } ?>
 <li>
 <a href="productcate1.php?page=<?php echo $total_page;?>" class = "btn btn-outline-success" aria-label="Next">
