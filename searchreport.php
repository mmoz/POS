...
$sql = "SELECT * FROM report WHERE productname  LIKE '%$productname%' AND stat LIKE 'ขาย%' ORDER BY productname ASC";
...
<tbody>
  ...
  <a href= "reportpage.php" class="btn btn-primary">ย้อนกลับ</a>
